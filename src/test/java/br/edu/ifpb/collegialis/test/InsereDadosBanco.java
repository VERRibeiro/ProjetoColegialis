...
/**
 * É presico comentar a dependência "weld-se" do pom.xml antes de executar estes
 * testes. A dependência importa uma versão do log4j que é incompatível com a
 * necessária pelo JUnit. Depois de executados os testes, retirar os comentários
 * na dependência para evitar os erros de compilação oriundos de classes que
 * fazem uso dela.
 * 
 * @author fred
 *
